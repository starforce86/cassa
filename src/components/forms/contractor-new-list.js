...
class NewContractorFormList extends Component {
    ...
    renderCard(card, index) {
        return (
            <TouchableHighlight key = {index} underlayColor={ASSET_STYLE.underlayColor} style={{ marginTop: 5, backgroundColor: (index % 2 === 0) ? ASSET_STYLE.containerBg : '#FFFFFF' }} elevation={10} onPress={() =>{
...
export default connect(mapStateToProps, mapDispatchToProps)(NewContractorFormList);
