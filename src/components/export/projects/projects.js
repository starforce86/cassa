...
import { getLocations, getProjectByTeam } from '../../../action/lookup';
...
class Projects extends Component {
    ...
    componentWillMount() {
        //const { params } = this.props.navigation.state;
        this.props.getProjectByTeam(this.props.token, this.props.team.id).then(data => {
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <View style={styles.containerInner}>
                    <FlatList data={this.state.projects} style={styles.cardList} keyExtractor={(item) => item.key}
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        getProjectByTeam: (token, teamId) => { return getProjectByTeam(token, teamId)}
    }
}
