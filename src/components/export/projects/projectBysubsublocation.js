...
import { getSubSubLocations ,getProjectBySubSubLocations} from '../../../action/lookup';
...
class SubSubLocations extends Component {
    ...
    componentWillMount() {
        const { params } = this.props.navigation.state;
        this.props.getProjectBySubSubLocations(this.props.token, this.props.team.id, params.parentId).then(data => {
            this.setState({
                sublocations: data
            });
        });
    ...
    projectClicked(project) {
        ...
        //     } else {
                navigate('RegisterForProject', {projectId:project.id,form:this.props.navigation.state.params['form'],path: this.props.navigation.state.params['path']});
        //     }
        // });
    }
