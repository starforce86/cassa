...
class Registers extends Component {
    ...
    projectClicked(project) {
        // console.log("$project:1:", project.id);
        // console.log("$project:2:", this.props.navigation.state.params['projectId']);
        // console.log("$project:3:", project.name);
        // console.log("$project:4:", this.props.navigation.state.params['form']);
        // console.log("$project:5:", this.props.navigation.state.params['path']);

        navigate('SubRegisterForProject', { parentId: project.id, projectId:this.props.navigation.state.params['projectId'], title: project.name,form:this.props.navigation.state.params['form'], path: this.props.navigation.state.params['path']});
    }
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <View style={styles.containerInner}>
                    <FlatList data={this.state.registers} style={styles.cardList} keyExtractor={(item) => item.id}
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        getRegisters: (token, teamId) => { return getRegisters(token, teamId)}
    }
}
