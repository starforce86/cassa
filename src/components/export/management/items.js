...
import { getItems } from '../../../action/lookup';
...
class Items extends Component {
    ...
    renderHeader() {
        ...
        //console.warn(params.parentId)
        console.log("Inside items.js");
        return (
    ...
    componentWillMount() {
        const { params } = this.props.navigation.state;
        //  console.warn(this.props.team.id)
        this.props.getItems(this.props.token, { registerId: params.parentId, teamId: this.props.team.id, projectId: params.projectId }).then(data => {
            //    console.warn(data)
            this.setState({
                items: data
            });
    ...
    projectClicked(project) {
        //        console.warn(project.register_submitted_record_id)
        console.log(project);
        navigate('ExportAction', { categoryRegisterId: this.props.navigation.state.params['parentId'], title: project.name, projectId: this.props.navigation.state.params['projectId'], form: this.props.navigation.state.params['form'], item_id: project.register_submitted_record_id, path: this.props.navigation.state.params['path'] });
    }
        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <View style={styles.containerInner}>
                    <FlatList data={this.state.items} style={styles.cardList} keyExtractor={(item) => item.id}
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        getItems: (token, registerId, projectId) => { return getItems(token, registerId, projectId) }
    }
}
