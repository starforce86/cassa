...
class Registers extends Component {
    ...
    projectClicked(project) {
        navigate('SubRegisters', { projectId:0,parentId: project.id, title: project.name,form:this.props.navigation.state.params['form'], path: this.props.navigation.state.params['path']});
    }
