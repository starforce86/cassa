...
//        console.log(this.props.team.id)
  ...
  //          console.warn(data)
            if(data && data.length > 0) {
                navigate('SubRegisters', { projectId:this.props.navigation.state.params['projectId'],parentId: project.id, title: project.name,form:this.props.navigation.state.params['form'], path: this.props.navigation.state.params['path']});
            } else {
                navigate('Items', {teamId:this.props.team.id,projectId:0,title: project.name, parentId: project.id,form:this.props.navigation.state.params['form'], path: this.props.navigation.state.params['path']});
            }
        });
    }
