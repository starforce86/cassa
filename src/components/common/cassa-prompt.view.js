...
export default class CassaPrompt extends Component{
  static defaultProps={
    show:false,
    title:'',
    onCancel:()=>{},
      ...
      this.props.show?
        <ScrollView style={styles.masker} keyboardDismissMode={'on-drag'}>
          <View style={[styles.container,this.props.style]}>
            ...
            {this.props.description?(typeof this.props.description==='string'?<Text style={styles.description}>{this.props.description}</Text>:this.props.description):null}
            {myContent}
